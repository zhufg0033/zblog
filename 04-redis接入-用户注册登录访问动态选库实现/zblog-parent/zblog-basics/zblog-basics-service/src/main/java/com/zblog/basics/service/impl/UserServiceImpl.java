...
import com.zblog.basics.utils.BeanMapUtils;
import com.zblog.basics.vo.AccountProfile;
import com.zblog.basics.vo.BadgesCount;
...
public class UserServiceImpl implements UserService {
    ...
    public AccountProfile login(String username, String password) {
        ...
        AccountProfile accountProfile = BeanMapUtils.copyPassport(mtoUser);
    ...
    public UserVO register(UserVO user) {
        ...
        return BeanMapUtils.copy(mtoUser);
    }
