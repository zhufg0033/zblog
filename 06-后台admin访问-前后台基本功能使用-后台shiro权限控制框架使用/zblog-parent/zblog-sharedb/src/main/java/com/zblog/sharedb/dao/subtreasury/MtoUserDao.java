...
public interface MtoUserDao {
    ...
    List<MtoUser> findLikeUsername(String userName);
    ...
    @Select({"select count(*) from mto_user"})
    long count();
    ...
    int updateComments(@Param("ids") List<Long> ids, @Param("increment") int increment);
}