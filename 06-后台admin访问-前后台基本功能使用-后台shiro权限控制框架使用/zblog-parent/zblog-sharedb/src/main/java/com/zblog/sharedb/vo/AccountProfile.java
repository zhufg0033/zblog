...
public class AccountProfile implements Serializable {
    ...
    public AccountProfile(long id,String username, String avatar, String name, String email, Date lastLogin,
                          int status, BadgesCount badgesCount, String signDb, PermissionInfo permissionInfo) {
        this.id = id;
